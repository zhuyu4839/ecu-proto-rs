...
impl RequestData for IOCtrlData {
...
mod tests {
    ...
    fn new() -> anyhow::Result<()> {
        ...
        let request = IOCtrlData::try_from(&source[1..])?;
        assert_eq!(request.did, DataIdentifier::VehicleManufacturerSpecific(0x4101));
