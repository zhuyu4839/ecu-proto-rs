            ...
            Some(mode) => {
                ...
                match mode {
                    ModeOfOperation::AddFile => {
                        ...
                        let max_block_len = utils::slice_to_u128(&data[offset..offset + lfi as usize], true);
                        offset += lfi as usize;
                    ...
                    ModeOfOperation::ReadFile => {
                        ...
                        let uncompressed_size_or_dir_len = utils::slice_to_u128(&data[offset..offset + filesize_or_dir_param_len as usize], true);
                        offset += filesize_or_dir_param_len as usize;

                        let compressed_size = utils::slice_to_u128(&data[offset..], true);
